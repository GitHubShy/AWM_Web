...
<div class="login">
	...
	<div class="bottom-box">© 2020 Prezi Inc. <a href="">Terms</a></div>
</div>
</template>
...
import { registerCustomer } from "../network/Customer";
import { employeeLogin } from "../network/Employee";
...
export default {
        ...
        return {
			...
			rules: {
				account_name: [
                    ...
                    { min: 3, max: 10, message: 'The length must be between 3 and 10' }
				],
				password: [
					{ required: true, message: 'Please input password' },
                    { min: 6, max: 20, message: 'The length must be between 6 and 20' }
				],
				email: [
				...
				portrsit_url: [
					{ required: true, message: 'Please input portrsit url' },
				],
				phone: [
    ...
    methods: {
		...
		async login() {
			...
			let { account_name, password } = this;
			let parmas = {
				account_name,
				password
			}
